...
rv_predict <- predict(tree_pruned_rv, test)
ROCR_rv <- prediction(rv_predict, test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
rv_p_predict <- predict(tree_pruned_rv_p, test)
ROCR_rv_p <- prediction(rv_p_predict, test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
all_predict <- predict(tree_pruned_all, test)
ROCR_all <- prediction(all_predict, test$has_reviews_2016)
...
ROCR_tree <- prediction(predict_tree, test$has_reviews_2016)

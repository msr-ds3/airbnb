...
ROCR_rv_p <- prediction(rv_p_predict, skimmed_test$has_reviews_2016)
...
ROCR_rf_rv_p <- prediction(rf_rv_p_predict, skimmed_test$has_reviews_2016)
...
ROCR_amen <- prediction(predict_amen, skimmed_test$has_reviews_2016)
...
ROCR_tree <- prediction(predict, skimmed_test$has_reviews_2016)
...
ROCR_ver <- prediction(predict_ver, skimmed_test$has_reviews_2016)
...
ROCR_all <- prediction(predict_all, skimmed_test$has_reviews_2016)
...
ROCR_word <- prediction(word_predict, skimmed_test$has_reviews_2016)
...
ROCR_purged <- prediction(purged_predict, skimmed_test$has_reviews_2016)
...
ROCR_location <- prediction(location_predict, skimmed_test$has_reviews_2016)
...
ROCR_all <- prediction(all_predict, skimmed_test$has_reviews_2016)
...
ROCR_non <- prediction(non_predict, skimmed_test$has_reviews_2016)

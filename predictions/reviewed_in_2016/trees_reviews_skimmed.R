...
ROCR_rf <- prediction(rf_predict, skimmed_test$has_reviews_2016)
...
ROCR_rv <- prediction(rv_predict, skimmed_test$has_reviews_2016)
...
ROCR_p <- prediction(p_predict, skimmed_test$has_reviews_2016)
...
ROCR_rf_rv <- prediction(rf_rv_predict, skimmed_test$has_reviews_2016)
...
ROCR_rf_p <- prediction(rf_p_predict, skimmed_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
word_rf_predict <- predict(tree_pruned_word_rf, skimmed_test)
ROCR_word_rf <- prediction(word_rf_predict, skimmed_test$has_reviews_2016)

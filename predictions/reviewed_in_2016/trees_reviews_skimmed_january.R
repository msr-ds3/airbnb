...
#use the tree_pruned_rf to predict on the test set
rv_predict <- predict(tree_pruned_rv, skimmed_jan_test)
ROCR_rv <- prediction(rv_predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
p_predict <- predict(tree_pruned_p, skimmed_jan_test)
ROCR_p <- prediction(p_predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
rf_rv_predict <- predict(tree_pruned_rf_rv, skimmed_jan_test)
ROCR_rf_rv <- prediction(rf_rv_predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
rf_p_predict <- predict(tree_pruned_rf_p, skimmed_jan_test)
ROCR_rf_p <- prediction(rf_p_predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
rv_p_predict <- predict(tree_pruned_rv_p, skimmed_jan_test)
ROCR_rv_p <- prediction(rv_p_predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
rf_rv_p_predict <- predict(tree_pruned_rf_rv_p, skimmed_jan_test)
ROCR_rf_rv_p <- prediction(rf_rv_p_predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
predict_amen <- predict(tree_pruned_amen, skimmed_jan_test)
ROCR_amen <- prediction(predict_amen, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
predict <- predict(tree_pruned, skimmed_jan_test)
ROCR_tree <- prediction(predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
predict_ver <- predict(tree_pruned_ver, skimmed_jan_test)
ROCR_ver <- prediction(predict_ver, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
predict_all <- predict(tree_pruned_all, skimmed_jan_test)
ROCR_all <- prediction(predict_all, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
word_predict <- predict(tree_pruned_word, skimmed_jan_test)
ROCR_word <- prediction(word_predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
purged_predict <- predict(tree_pruned_purged, skimmed_jan_test)
ROCR_purged <- prediction(purged_predict, skimmed_jan_test$has_reviews_2016)
...
##############################LOCATION TREE####################################
# reviews ~ location
tree_location <- rpart(has_reviews_2016 ~ #neighbourhood_cleansed +
...
#use the tree_pruned_rf to predict on the test set
location_predict <- predict(tree_pruned_location, skimmed_jan_test)
ROCR_location <- prediction(location_predict, skimmed_jan_test$has_reviews_2016)
...
# reviews ~ rf + rv + amen + location + ver
tree_all <- rpart(has_reviews_2016 ~  TV + Internet + Wireless.Internet +
                    Air.Conditioning + Kitchen + Heating + Family.Kid.Friendly + 
                    Smoke.Detector + Carbon.Monoxide.Detector + Essentials +
                    Shampoo + Cable.TV + Free.Parking.on.Premises + Breakfast +
...
prp(tree_pruned_all, faclen = 0, cex = 0.8, extra = 1)
#use the tree_pruned_rf to predict on the test set
all_predict <- predict(tree_pruned_all, skimmed_jan_test)
ROCR_all <- prediction(all_predict, skimmed_jan_test$has_reviews_2016)
...
#REVIEWS ~ AMEN + VER + WORDS + LOCATION + ROOM TYPE

tree_non_rfrv <- rpart(has_reviews_2016 ~ min_price + 
...
#use the tree_pruned_rf to predict on the test set
non_predict <- predict(tree_pruned_non, skimmed_jan_test)
ROCR_non <- prediction(non_predict, skimmed_jan_test$has_reviews_2016)
...
#use the tree_pruned_rf to predict on the test set
word_rf_predict <- predict(tree_pruned_word_rf, skimmed_jan_test)
ROCR_word_rf <- prediction(word_rf_predict, skimmed_jan_test$has_reviews_2016)
